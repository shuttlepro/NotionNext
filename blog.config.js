...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '夏桃子', // 您的昵称 例如 tangly1024
  
  BIO: process.env.NEXT_PUBLIC_BIO || 'Happy Coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://shuttlepro.world', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Java教程,三味书屋,博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/shuttlepro', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-earth.css', // 代码块默认主题
  ...
  PRISM_THEME_DARK_PATH:
    ...
    'https://npm.elemecdn.com/prism-themes/themes/prism-duotone-earth.css', // 深色模式主题
  ...
  BACKGROUND_LIGHT: '#faf9de', // use hex value, don't forget '#' e.g #fffefc
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '桃子同学的三味书屋', // 站点描述，被notion中的页面描述覆盖
